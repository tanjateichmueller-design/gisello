...
type SubItem = { label: string; to: string; img?: string; desc?: string };

type NavItem =
  | { label: string; to: string }
  | { label: string; children: SubItem[] }
  | {
      label: string;
      mega: true;
      categories: { title: string; img?: string; items: SubItem[] }[];
    };
        ...
        items: [
          {
            ...
            img: ivfOwnImg,
            desc: "Using your own eggs at AI-matched clinics.",
          },
          {
            label: "IVF with Donor Eggs",
            to: "/treatments/fertility-care",
            img: ivfDonorImg,
            desc: "Screened donor-egg cycles with full coordination.",
          },
          {
            label: "Embryo Freezing",
            to: "/treatments/fertility-care",
            img: embryoImg,
            desc: "Cryopreserve embryos for future family planning.",
          },
          {
            label: "Egg Freezing",
            to: "/treatments/fertility-care",
            img: eggImg,
            desc: "Preserve fertility on your timeline.",
          },
          {
            label: "Genetic Testing",
            to: "/treatments/fertility-care",
            img: geneticImg,
            desc: "PGT-A / PGT-M screening before transfer.",
          },
          {
            label: "Surrogacy",
            to: "/treatments/fertility-care",
            img: surrogacyImg,
            desc: "Coordinated gestational surrogacy abroad.",
          },
        ],
      },
    ],
...
export function NavBar({
  ...
  const navBg = transparent
    ? "nav-transparent"
    : "bg-paper border-b sticky";

  return (
    <header
      className={`w-full top-0 z-40 ${navBg}`}
      style={
        transparent ? undefined : { borderColor: "var(--color-rule)" }
      }
    >
      <div
