...
const CARDS: Card[] = [
  ...
  },
  {
    ...
    body: "Your dedicated Patient Navigator has a medical background. She coordinates, handholds and guides you through the medical journey, available by call and WhatsApp.",
  },
  {
    img: companion,
